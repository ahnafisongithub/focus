...
<div class="w3-black w3-center">
    <h1  >Hello!</h1>
    <h1  >Welcome to the Compressed Uploads/Downloads section!</h1>

    <hr>
    <hr>

    <form action="compressed_create.php" method="post">
...
<hr>
    ...
    <form action="compressed_upload.php" method="post" enctype="multipart/form-data">
...
<hr>
    ...
    <p>STEP 3: COMPRESS THE FILE ON THE SERVER </p>
    <label for="name4">Enter nickname [MUST MATCH FOLDER NAME!]:</label>
  ...
  <br>
        ...
        <button href="" class="btn w3-blue"><i class="fa fa-download "></i> Zip it!</button>
...
<!-- 
    ...
    <form action="compressed_download.php" method="post" enctype="multipart/form-data">
    <p>STEP 4: DOWNLOAD THE COMPRESSED FILE ON THE SERVER </p>
